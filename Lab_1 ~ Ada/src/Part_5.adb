...
procedure Part_5 is
   ...
   package DIO is new Text_Io.Fixed_Io(Duration); --To print Duration variables you can instantiate the generic
                                                 --package Text_Io.Fixed_Io with a duration type:
                                                  ...
                                                  --to print variable D of type Duration.

   --An integer between 0 and 3 used in determine WHEN F3 exceeds its deadline
   subtype Num_Gen is Integer range 0 .. 3;
...
begin
   ...
   --Main loop
   loop
    rand_float :=  float(Random(seed)); -- Get the random number and save as rand_float
